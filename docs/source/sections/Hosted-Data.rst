...
ISB-CGC hosts a seriese of reference tables in BigQuery with information that describes or annotates the human (or other) genome(s) or is necessary to work with data generated by specific platforms.

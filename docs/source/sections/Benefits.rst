...
Working in the cloud is exceptionally scalable and versatile, you only use as much as you need, whether that's in terms of storage space or processing cores. Cloud-based data is easily read by massively parallel processes, in turn expediting results. When you're done, it disappears! You don't have idle resources sitting around collecting dust. 

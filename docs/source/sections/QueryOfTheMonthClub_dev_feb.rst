...
by Krzywinski et al., Genome Research, 2009 (cited by 3295!), and originally
...
relationships between pairs of positions by the use of ribbons". A good example
illustrates genomic rearrangements. It is also a very good way to
visualize gene-gene interactions which are often between genomically-distant genes.
...
I learned a few new things about Shiny this month,
so we'll go through the app, and see how it works.

...
**COSMIC Release v86 update**: Two new BigQuery datasets now contain *all* of the tables
...
many more types of queries -- please explore them at (after registering for access as described below):
    - `isb-cgc:COSMIC_v86_grch38 <https://bigquery.cloud.google.com/dataset/isb-cgc:COSMIC_v86_grch38>`_
    - `isb-cgc:COSMIC_v86_grch37 <https://bigquery.cloud.google.com/dataset/isb-cgc:COSMIC_v86_grch37>`_
...
in COSMIC and are also found (though generally rarely) in Kaviar.

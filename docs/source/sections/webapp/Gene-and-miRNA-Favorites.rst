...
**Terminology Used for miRNA**
  * The `miRBase <http://www.mirbase.org/index.shtml>`_ created a microRNA database center to enable researchers to understand the published miRNA sequences and annotations.  Which is currently maintained by the Griffiths-Jones lab at the `Faculty of Life Sciences, University of Manchester <https://www.bmh.manchester.ac.uk/>`_.  

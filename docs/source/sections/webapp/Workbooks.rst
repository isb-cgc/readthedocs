...
**ANNOUCEMENT:** For OncoPrint, OncoGrid, and SeqPeek analyses we provide a default gene list. Genes with consensus score of 6 or higher are added to the gene list. (Ref: `Bailey et al., Cell. 2018 Apr 5;173(2):371-385.e18. doi: 10.1016/j.cell.2018.02.06 <https://www.sciencedirect.com/science/article/pii/S009286741830237X?via%3Dihub>`_ )

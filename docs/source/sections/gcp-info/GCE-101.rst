...
ISB-CGC is a thin layer on top of the Google Cloud Platform. Users have at their disposal all of the tools and techologies that the Google Cloud Platform has to offer including full **sudo** access to Google Cloud virtual machines. Your main source of information for official Google Cloud Platform is their `documentation <https://cloud.google.com/docs>`_.
...
These workflow examples serve to demonstrate how demonstrate the language syntax of Nextflow, CWL, WDL and Snakemake. 

...
We have put together some basic documentation for ISB-CGC users who are new to the Google Cloud Platform as well as the commonly used workflow languages in bioinformatics research.  Your main source of information for the official Google Cloud Platform `documentation is: <https://cloud.google.com/docs>`_.

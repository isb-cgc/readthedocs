...
Metadata for these files can be found in BigQuery, in the ISB-CGC metadata `dataset <https://console.cloud.google.com/bigquery?p=isb-cgc&d=metadata&page=dataset>`_.

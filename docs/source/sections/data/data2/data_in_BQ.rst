...
- `isb-cgc:tcga_201510_alpha <https://bigquery.cloud.google.com/dataset/isb-cgc:tcga_201510_alpha>`_: This dataset contains one table for each of the major datatypes and/or platforms.  All tables include one or more of the following identifiers which can be used for performing cross-table JOINs: ``ParticipantBarcode``, ``SampleBarcode``, and ``AliquotBarcode``.  In addition, most tables contain a ``Study`` field which contains the tumor-type abbreviation (*eg* LUAD, BRCA, *etc*). (The table ordering below is alphabetical, since that is the same order you will see if you click on the link above to view this dataset using the `BigQuery web UI <https://bigquery.cloud.google.com/welcome>`_.)
  ...
  + `mRNA_BCGSC_HiSeq_RPKM <https://bigquery.cloud.google.com/table/isb-cgc:tcga_201510_alpha.mRNA_BCGSC_HiSeq_RPKM>`_: This table ...
  + `mRNA_UNC_HiSeq_RSEM <https://bigquery.cloud.google.com/table/isb-cgc:tcga_201510_alpha.mRNA_UNC_HiSeq_RSEM>`_: This table ...
  + `Protein_RPPA_data <https://bigquery.cloud.google.com/table/isb-cgc:tcga_201510_alpha.Protein_RPPA_data>`_: This table ...
  + `Somatic_Mutation_calls <https://bigquery.cloud.google.com/table/isb-cgc:tcga_201510_alpha.Somatic_Mutation_calls>`_: This table ...

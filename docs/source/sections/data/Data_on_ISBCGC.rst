...
Part of the mission of the ISB-CGC has been to explore the best ways to use the available cloud technologies to provide access to the
hosted data.  To this end, the data is made available using these three main Google Cloud Platform technologies:

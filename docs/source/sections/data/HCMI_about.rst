...
HCMI data consists of 23 cases with over 450 phenotyped subjects with whole-exome sequencing, RNA sequencing, and whole-genome sequencing data. The NCI GDC houses all the clinical, biospecimen, and molecular characterization data with over 460 VCF, 261 BAM, 123 TXT, 57 TSV, and 23 BRC XML files. The project identification in the GDC Data Portal is `HCMI-CMDC <https://portal.gdc.cancer.gov/projects/HCMI-CMDC>`_.

...
HCMI data consists of over 450 phenotyped subjects with Whole Exome Sequencing, RNA Sequencing, and Whole Genome Sequencing data. The NCI GDC houses all the clinical, biospecimen, and molecular characterization data with over 100 VCF, 80 BAM, 40 TXT, 25 TSV, and 5 BRC XML files in around 2.7 TB of data. More information on this data set is available from the GDC Portal. The program identification in the GDC is `HCMI-CMDC <https://portal.gdc.cancer.gov/projects/HCMI-CMDC>`_.

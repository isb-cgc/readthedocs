...
When you access BigQuery from your Google Cloud Platform Console (see link `here <HowToAccessBigQueryFromTheGoogleCloudPlatform.rst>`_ for more information on this), you will be presented with the following page:

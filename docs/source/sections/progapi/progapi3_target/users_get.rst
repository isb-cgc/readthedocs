...
**Example**::
	...
	python isb_curl.py https://api-dot-isb-cgc.appspot.com/_ah/api/isb_cgc_target_api/v3/users
...
HTTP request::
	...
	GET https://mvm-api-dot-isb-cgc.appspot.com/_ah/api/isb_cgc_target_api/v3/users

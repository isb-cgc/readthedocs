...
**Example**::
	...
	curl --data '{"sample_barcodes": ["TCGA-DX-A23Z-10A","TCGA-B9-7268-01A"]}' https://api-dot-isb-cgc.appspot.com/_ah/api/isb_cgc_tcga_api/v3/tcga/samples
...
**Python API Client Example**::
	...
	data = service.samples().get(body={"sample_barcodes": ["TCGA-W5-AA2R-01A","TCGA-DX-A23Z-10A"]}).execute()
...
HTTP request::
	...
	POST https://api-dot-isb-cgc.appspot.com/_ah/api/isb_cgc_tcga_api/v3/tcga/samples
{
    "sample_barcodes": [
        "TCGA-DX-A23Z-10A",
        "TCGA-B9-7268-01A"
...
.. csv-table::
	...
	sample_barcodes,[string],"Required. "

...
.. csv-table::
	...
	frozen_specimen_anatomic_site,string,"Optional. "
	...
	has_27k,boolean,"Optional. "
	has_450k,boolean,"Optional. "
	has_BCGSC_GA_RNASeq,boolean,"Optional. "
	has_BCGSC_HiSeq_RNASeq,boolean,"Optional. "
	has_GA_miRNASeq,boolean,"Optional. "
	has_HiSeq_miRnaSeq,boolean,"Optional. "
	has_Illumina_DNASeq,boolean,"Optional. "
	has_RPPA,boolean,"Optional. "
	has_SNP6,boolean,"Optional. "
	has_UNC_GA_RNASeq,boolean,"Optional. "
	has_UNC_HiSeq_RNASeq,boolean,"Optional. "
	...
	history_of_prior_malignancy,string,"Optional. "
	...
	mononucleotide_marker_panel_analysis_status,string,"Optional. "
	...
	ParticipantBarcode,string,"Optional. "
	...
	SampleBarcode,string,"Optional. "
	SampleTypeCode,string,"Optional. "
	Study,string,"Optional. "
	tobacco_smoking_history,string,"Optional. "
	TSSCode,string,"Optional. "
	...
	weiss_venous_invasion,string,"Optional. "
	year_of_initial_pathologic_diagnosis,integer,"Optional. "

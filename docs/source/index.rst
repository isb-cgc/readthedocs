...
|                                   |- Cohorts `set operations <search.html?q=set+operations&check_keywords=yes&area=default>`_                                                                                                    |- de novo using ISB-CGC `Endpoints </progapi/Programmatic-API.html>`_, , BigQuery Command Line Tool                                                                                                                  |

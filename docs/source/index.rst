...
+-----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|Create cohorts of patients         |- `Create cohorts </webapp/Saved-Cohorts.html>`_                                                                                                                                              |- Use GUI saved cohorts and ISB-CGC `Endpoints </progapi/Programmatic-API.html>`_                                                                                                                                                                              |
|                                   |- Cohorts `set operations <search.html?q=set+operations&check_keywords=yes&area=default>`_                                                                                                    |- de novo using ISB-CGC `Endpoints </progapi/Programmatic-API.html>`_ , BigQuery `Command Line Tool <https://cloud.google.com/bigquery/bq-command-line-tool-quickstart>`_ and BigQuery `REST API <https://cloud.google.com/bigquery/bigquery-api-quickstart>`_ |                                                                                      |

...
|                                   |- View Sequences with `IGV </webapp/IGV-Browser.html>`_                                                                         |- Google Genomics APIs `from cohort </progapi/progapi2/google_genomics_from_cohort.html>`_ or `from sample </progapi/progapi2/google_genomics_from_sample.html>`_ |

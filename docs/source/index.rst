...
|                                   |                                                                                                                                |- Google Genomics APIs `from cohort </progapi/progapi2/google_genomics_from_cohort.html>`_ or `from cohort </progapi/progapi2/google_genomics_from_sample.html>`_ |
+-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|Understand details of data         |- `Access TCGA controlled data </webapp/Gaining-Access-To-TCGA-Contolled-Access-Data.html>`_                                    |- BigQuery `R and Python Tutorials </progapi/Tutorials.html>`_                                                                                                    |
|                                   |- `View File List </webapp/Saved-Cohorts.html?highlight="view file list">`_ in GUI                                              |- ISB-CGC `Endpoints </progapi/Programmatic-API.html>`_                                                                                                           |
|                                   |- View Sequences with `IGV </webapp/IGV-Browser.html>`_                                                                         |- Google Genomics APIs `from cohort </progapi/progapi2/google_genomics_from_cohort.html>`_ or `from cohort </progapi/progapi2/google_genomics_from_sample.html>`_ |
|                                   |- `Google BigQuery Web UI </progapi/bigqueryGUI/WalkthroughOfGoogleBigQuery.rst>`_                                              |                                                                                                                                                                  |
|                                   |- `Google API Explorer <https://apis-explorer.appspot.com/apis-explorer/?base=https://api-dot-isb-cgc.appspot.com/_ah/api#p/>`_ |                                                                                                                                                                  |
+-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|Create cohorts of patients         |                                                                                                                                |- blocks.                                                                                                                                                         |
+-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|Combine multiple ISB-CGC datasets  |                                                                                                                                |- blocks.                                                                                                                                                         |
+-----------------------------------+--------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------+
